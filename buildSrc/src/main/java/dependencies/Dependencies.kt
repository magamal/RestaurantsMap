...
//        "androidx.test:runner:${Versions.Testing.runner}",
    ...
    const val OpenStreetMap = "org.osmdroid:osmdroid-android:${Versions.OpenStreetMap}"

    const val PlayCore = "com.google.android.play:core-ktx:${Versions.PlayCoreVersion}"
    const val LocationGooglePlayServices =
        "com.google.android.gms:play-services-location:${Versions.LocationPlayServiceVersion}"
